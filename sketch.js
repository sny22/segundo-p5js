var celesteNegativo;
var verdeClaritoNegativo;
var verdeGrisaseoNegativo;
var verdeOscuroNegativo;
var naranjaNegativo;
var celesteOscuroNegativo;
var azulClaritoNegativo;
var moradoNegativo;
var cremaNegativo;
var celesteClaritoNegativo;
var violetaAzuladoNegativo;
var grisNegativo;
var grisClaritoNegativo;
var azulNegativo;
var violetaNegativo;
var violetaClarito;
var lilaNegativo;
...
function draw() {
  ...
  cremaNegativo = color(48, 63, 84);
  segundoFondo = color(201, 199, 187);

  //tercer cuadrado negativo
  cremaNgeativo = color(55, 71, 87);
  ...
  if (keyIsPressed){
    if (key=="a"){
      if (contador==0){
        if (pmouseX >800 || pmouseX < 200 || pmouseY >800 || pmouseY<200){
        stroke(0);
        beginShape();
        vertex(85,190);
        vertex(205,450);
